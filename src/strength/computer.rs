...
use crate::{draught::Draught, math::Bounds, Error, IDisplacement};
...
use super::{
    ...
    volume::Volume,
    IMass, ITotalForce, IVolume, Trim,
};
use std::rc::Rc;
...
/*      self.results
            .add("value_displacement".to_owned(), displacement_values);
        self.results
            .add("value_total_force".to_owned(), total_force_values);
        self.results
            .add("value_shear_force".to_owned(), shear_force_values);
        self.results
            .add("value_bending_moment".to_owned(), bending_moment_values);
 */       Ok(())
    }
}
